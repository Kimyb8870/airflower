...
const insertAction = async (pool, ActionInsertParam) => {
  ...
  const sql = `INSERT INTO TB_ACTION_QUEUE (ACTION_ID, SCHEDULE_ID, ACTION_TYPE, CONTROLLER_ID, ACTION_DATETIME, REQUEST_DATETIME) VALUES("${ACTION_ID}", "${SCHEDULE_ID}", "${ACTION_TYPE}", "${CONTROLLER_ID}", NOW(), NOW());`;
  let result = null;
